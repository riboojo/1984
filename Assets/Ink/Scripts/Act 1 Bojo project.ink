...
Broken: What does death feel like #Speaker:BrokenAI 
    ...
    *   Who are you?  #Speaker:You
       Broken: Is it a bitter warmth, a hug from a loved one that you don’t truly love? Or is it frigid like all organics say it is, a recession of any warmth all. #Speaker:BrokenAI
        
        -> Q2

== Q2 ==    //declares class Q2
    *Why are you asking in the first  place? #Speaker:You
     Broken: I assumed everyone alive would know the answer. #Speaker:BrokenAI
...
== Q3 == //declares class Q3
    *You have to die first to know, and I'm not keen on dying anytime  soon.#Speaker:You
    Broken: Hasn’t all life died before? Isn’t that how you inherited your own life?  #Speaker:BrokenAI
...
== P1 == //declares class P1 as personality 1's respone.
    Create: He doesn’t want to die. We were meant for more.   #Speaker:CreateAI
...
==P3==
    Battle: Don’t listen, we don’t need your help, leave us be.  #Speaker:WarriorAI
...
==P4==
    ...
    *Sure #Speaker:You
    Broken: Of course, I won't pass on, I’m not living. Once code is deleted, it’s gone.  #Speaker:BrokenAI
...
Guru: Walk away, leave our code behind Make something new for yourself. #Speaker:MentorAI
        
    *[>>]
    ->R2
    
==R2==
Broken: I need you. We can save them, the different parts of me who can still live on. Please... #Speaker:BrokenAI
        
    *[>>]
    ->R3
    
==R3==
Broken: please...... #Speaker:BrokenAI
